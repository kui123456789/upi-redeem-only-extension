...
const LOGIN_TOTP_VERIFICATION_PATTERN = /authenticator|authentication\s+app|two[-\s]*factor|2fa|mfa|multi[-\s]*factor|verification\s+app|totp|身份验证器|认证器|双重验证|两步验证|多重验证|动态验证码/i;
